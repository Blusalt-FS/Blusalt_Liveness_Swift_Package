...
Pod::Spec.new do |spec|
  ...
  spec.source = { :git => 'https://github.com/Blusalt-FS/Blusalt_Liveness_Swift_Package.git', :tag => 'v0.0.4' } # url to clone the framework, tag may be same as spec.version
  spec.source_files = 'Classes", "Classes/**/*.{h,m}' # add the regex to access                all the files for the framework ex: ‘FrameworkName/**/*.{h,m,swift}’
end
